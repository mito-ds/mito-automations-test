...
def Aaron_8(import_dataframe_0, file_name_import_csv_0):
...
# Run the automation
import_dataframe_0 = r"automations/Aaron_8/data/importers=[CUSTOM_IMPORT]"
file_name_import_csv_0 = r"automations/Aaron_8/data/dataset.csv"
Aaron_8(import_dataframe_0, file_name_import_csv_0)