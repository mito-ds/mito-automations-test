...
def formatexcel(file_name_import_csv_0, file_name_export_excel_0):
...
os.makedirs(f"automations/FormatExcel/runs/{export_time}")
# List all of the folders, so we can debug automation
print(os.getcwd())
print(os.listdir(f"automations"))
print(os.listdir(f"automations/FormatExcel"))
print(os.listdir(f"automations/FormatExcel/runs"))
print(os.listdir(f"automations/FormatExcel/runs/{export_time}"))

# Run the automation
file_name_import_csv_0 = r"automations/FormatExcel/data/df_export.csv"
file_name_export_excel_0 = f"automations/FormatExcel/runs/{export_time}/file_name_export_excel_0.csv"
formatexcel(file_name_import_csv_0, file_name_export_excel_0)