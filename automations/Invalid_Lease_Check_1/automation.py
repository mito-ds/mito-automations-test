...
def Invalid_Lease_Check_1(file_name_import_csv_0, file_name_import_csv_1, file_name_export_excel_0):
    ...
    with pd.ExcelWriter(file_name_export_excel_0, engine="openpyxl") as writer:
        df_merge.to_excel(writer, sheet_name="df_merge", index=False)
    
    return commercial_real_estate_snowflake, Prologis_v1, df_merge


# Create a folder for this run
export_time = sys.argv[1]
os.makedirs(f"automations/Invalid_Lease_Check_1/runs/{export_time}")

# Run the automation
file_name_import_csv_0 = r"automations/Invalid_Lease_Check_1/data/commercial_real_estate_snowflake.csv"
file_name_import_csv_1 = r"automations/Invalid_Lease_Check_1/data/Prologis v1.csv"
file_name_export_excel_0 = f"automations/Invalid_Lease_Check_1/runs/{export_time}/file_name_export_excel_0.xlsx"
Invalid_Lease_Check_1(file_name_import_csv_0, file_name_import_csv_1, file_name_export_excel_0)