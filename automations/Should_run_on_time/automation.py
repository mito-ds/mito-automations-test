...
def Should_run_on_time(file_name_import_csv_0, file_name_export_excel_0):
...
os.makedirs(f"automations/Should_run_on_time/runs/{export_time}")

# Run the automation
file_name_import_csv_0 = r"automations/Should_run_on_time/data/df_export.csv"
file_name_export_excel_0 = f"automations/Should_run_on_time/runs/{export_time}/file_name_export_excel_0.xlsx"
Should_run_on_time(file_name_import_csv_0, file_name_export_excel_0)