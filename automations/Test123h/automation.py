...
def Test123h(file_name_import_csv_0, file_name_import_csv_1, file_name_import_csv_2, file_name_export_csv_0):
...
os.makedirs(f"automations/Test123h/runs/{export_time}")

# Run the automation
file_name_import_csv_0 = r"automations/Test123h/data/commercial_real_estate_snowflake.csv"
file_name_import_csv_1 = r"automations/Test123h/data/Prologis v1.csv"
file_name_import_csv_2 = r"automations/Test123h/data/Warehouse REIT v1.csv"
file_name_export_csv_0 = f"automations/Test123h/runs/{export_time}/file_name_export_csv_0.csv"
Test123h(file_name_import_csv_0, file_name_import_csv_1, file_name_import_csv_2, file_name_export_csv_0)