...
def loancountpivotnew(file_name_import_csv_0, file_name_export_excel_0):
...
os.makedirs(f"automations/LoanCountPivotNew/runs/{export_time}")

# Run the automation
file_name_import_csv_0 = r"automations/LoanCountPivotNew/data/loans_export.csv"
file_name_export_excel_0 = f"automations/LoanCountPivotNew/runs/{export_time}/file_name_export_excel_0.xlsx"
loancountpivotnew(file_name_import_csv_0, file_name_export_excel_0)